...
<body onload="onLoad();">
			...
			<div class="containerDiv">
				...
				<div class="panel">
					<div class="hairline">
						...
						<div class="question floatLeft">During the past 5 years, has
							the name of the Insured(s) been changed?</div>
						<div class="yesNo swithLabelAlign">
							<label class="switch"> <input type="checkbox"
								class="switch-input" id="flip-1"> <span
								class="switch-label" id="flip-1" data-on="Yes" data-off="No"></span>
					...
					<div class="hairline">
						...
						<div class="question floatLeft">During the past 5 years, has
							any other business(es) been purchased, merged or consolidated
							with the Insured?</div>
						<div class="yesNo swithLabelAlign">
							<label class="switch"> <input type="checkbox"
								class="switch-input" id="flip-1"> <span
								class="switch-label" id="flip-1" data-on="Yes" data-off="No"></span>
					...
					<div class="hairline">
						...
						<div class="question floatLeft">Please indicate the type of
							professional services provided and the approximate percentage of
							each relative to the Firm's total gross fee income</div>
						<div class="yesNo swithLabelAlign">
							<input type="text" class="percentageInput" />
						</div>
					</div>

					<div class="activityDiv">
						<div class="headerDiv activity floatLeft">7. Activity/
							Nature of Work</div>
						<div class="headerDiv activity floatLeft">
							<div class="percentageHeader">Percentage (%) of Fee Income</div>
						</div>
					</div>
					...
					<div class="fullWidth">
						<div class="sNo floatLeft"></div>
						<div class="question floatLeft">
							<strong>Please give the following fee income details:</strong>
						</div>
					...
					<div class="hairline">
						<div class="sNo floatLeft"></div>
						<div class="yearCol floatLeft">Previous Completed Financial
							Year</div>
						<div class="countryCol floatLeft">
							<input type="text" class="percentageInput" />
						</div>
						<div class="countryCol floatLeft">
							<input type="text" class="percentageInput" />
				...
				<div class="panel">
					<div class="hairline">
						...
						<div class="question floatLeft">Does legal counsel always
							review your contracts, including changes to standard contracts/
							letters of engagement?</div>
						<div class="yesNo swithLabelAlign">
							<label class="switch"> <input type="checkbox"
								class="switch-input" id="flip-1"> <span
								class="switch-label" id="flip-1" data-on="Yes" data-off="No"></span>
					...
					<div class="hairline">
						...
						<div class="question floatLeft">Does the firm use
							sub-contractors? (sub-contractors includes any "outside
							consultants")</div>
						<div class="yesNo swithLabelAlign">
							<label class="switch"> <input type="checkbox"
								class="switch-input" id="flip-1"> <span
				...
				<button class="headerDiv accordion">Insurance & Loss
					History</button>
				<div class="panel">
					<div class="hairline">
						<div class="sNo floatLeft">11</div>
						<div class="question floatLeft">Is any partner, director or
							principal after inquiry aware of any claims ever been made
							against the Insured(s) or their predecessors in business or any
							of the present or former partners, directors or principals?</div>
						<div class="yesNo swithLabelAlign">
							<label class="switch"> <input type="checkbox"
								class="switch-input" id="flip-1"> <span
								class="switch-label" id="flip-1" data-on="Yes" data-off="No"></span>
					...
					<div class="hairline">
						...
						<div class="question floatLeft">Is any partner, director or
							principal after inquiry, aware of any circumstances or
							occurrences which may give rise to a claim against the Insured or
							their predecessors in business or any of the present or former
							partners, directors or principals?</div>
						<div class="yesNo swithLabelAlign">
							<label class="switch"> <input type="checkbox"
								class="switch-input" id="flip-1"> <span
								class="switch-label" id="flip-1" data-on="Yes" data-off="No"></span>
					...
					<div class="hairline">
						...
						<div class="question floatLeft">Please specify Limit of
							Liability desired</div>
						<div class="yesNo swithLabelAlign">
							<input type="text" class="percentageInput" />
						</div>
						<div class="remark floatLeft">Pass</div>
					...
					<div class="hairline">
						...
						<div class="question floatLeft">Please specify Deductible
							desired</div>
						<div class="yesNo swithLabelAlign">
							<input type="text" class="percentageInput" />
						</div>
	...
	<script type="text/javascript" src="${RESOURCE_ROOT}scripts/jquery.js"></script>
	<!-- <script
...
function firstAjaxCall()
{
	$.ajax({
	    ...
	    success : function(response) {
	        ...
	        //alert($('input[id="flip-1-vinod"]').is(':checked'));
	    },
...
{
	$('input[class="switch-input"]').on('click', function(){
		var labelTag = $( this ).parent().get(0);
		var parentDiv = $( labelTag ).parent().get(0);
		var remarksDiv = $( parentDiv ).next();
		
	    if ( $(this).is(':checked') ) {
	    	$(remarksDiv).html("Refer");
	    }
	    else {
	    	$(remarksDiv).html("Pass");
	    }
	});
}
